...
export default function Hollywood() {
  ...
  useEffect(() => {
    fetch("https://blogapp-node-backend-5r3annq8j-eswara7373.vercel.app/hollywoodPost")
      .then((res) => res.json()).then((json) => setPost(json));
  }, []);

  useEffect(() => {
    fetch("https://blogapp-node-backend-5r3annq8j-eswara7373.vercel.app/hollywoodFirstPost")
      .then((res) => res.json()).then((json) => setFirstPost(json));
  }, []);

  useEffect(() => {
    fetch("https://blogapp-node-backend-5r3annq8j-eswara7373.vercel.app/hollywoodTopPost")
