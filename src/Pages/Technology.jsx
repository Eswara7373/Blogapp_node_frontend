...
const Technology = () => {
  ...
  useEffect(() => {
    fetch("https://blogapp-node-backend-5r3annq8j-eswara7373.vercel.app/technologyPost")
      .then((res) => res.json()).then((json) => setPost(json));
  }, []);

  useEffect(() => {
    fetch("https://blogapp-node-backend-5r3annq8j-eswara7373.vercel.app/technologyFirstPost")
      .then((res) => res.json()).then((json) => setFirstPost(json));
  }, []);

  useEffect(() => {
    fetch("https://blogapp-node-backend-5r3annq8j-eswara7373.vercel.app/technologyTopPost")
